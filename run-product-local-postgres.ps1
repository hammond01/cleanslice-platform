# Run Product Service locally with PostgreSQL
...
Write-Host "  - Database 'productdb' must exist" -ForegroundColor Yellow
Write-Host ""
...
.\mvnw.cmd spring-boot:run -pl services/product-service
