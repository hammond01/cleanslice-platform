# Run Audit Service locally with PostgreSQL
# Requires Docker Compose infrastructure running (postgres, kafka)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Starting Audit Service (Local Mode)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  - Database 'auditdb' must exist" -ForegroundColor Yellow
Write-Host ""
Write-Host "Port: 8083" -ForegroundColor Yellow
Write-Host "Swagger UI: http://localhost:8083/swagger-ui.html" -ForegroundColor Green
Write-Host ""
...
.\mvnw.cmd spring-boot:run -pl services/audit-service/audit-adapters-in-rest
